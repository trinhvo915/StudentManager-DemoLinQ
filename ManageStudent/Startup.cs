...
namespace ManageStudent
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<DatabaseContext>(opts => opts.UseSqlServer(Configuration["ConnectionString:ManageSchool"]));

            Mapper.Initialize(config =>
            {
                config.CreateMap<Faculty, FacultyViewModel>().ReverseMap();
            });
